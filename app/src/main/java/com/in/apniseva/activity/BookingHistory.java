...
public class BookingHistory extends AppCompatActivity {
    ...
    TextView text_name,text_MobileNo,text_city,text_address_details,text_orderConfirmed, bookingid,
            subTotalPrice,payonvisite,TotalPrice,text_id;
                ...
                try {
                    ...
                    if (status.equals("OK")) {
                        ...
                        if(pin_verification_status.equals("1")){
                            ...
                            JSONObject jsonObject_technician = new JSONObject(technician_details);
                            ...
                            String techmobile = jsonObject_technician.getString("mobile");
